...
![Pic1]https://github.com/harrywang/pyprom/blob/master/output/exercise1.png
...
2. Complete the first week's courses on coursera</br>
  2.1 The introduction of process mining</br>
  2.2 Some review about data analysis including Decision trees, Associate rule learning, clustering, etc. </br>
